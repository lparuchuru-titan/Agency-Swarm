...
def resolve_context(
    ...
    ctx = {
        ...
        "defaultBaseBranch": dot.get("defaultBaseBranch", "main"),
        "defaultPrTargetBranch": dot.get("defaultPrTargetBranch", dot.get("defaultBaseBranch", "main")),
        "jiraBaseUrl": dot.get("jiraBaseUrl", "https://yourcompany.atlassian.net"),
        "jiraProjectKey": dot.get("jiraProjectKey") or dot.get("projectKey", "PROJ"),
        ...
        "jiraPrefix": dot.get("jiraPrefix", "PROJ"),
