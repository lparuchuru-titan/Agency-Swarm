...
- Track every deployment (IDs, components, result) and update the project runbook
  (`docs/Pantheon2026_CPQ_Sandbox_Runbook.md`) so other environments are reproducible.
