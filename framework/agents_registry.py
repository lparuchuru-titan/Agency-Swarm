...
AGENTS: List[Dict[str, Any]] = [
    ...
    # --- Requirements ---
    {
        ...
        "intents": ["jira", "story", "epic", "sfdclq", "subtask", "acceptance"],
        "kb_topics": [],
    ...
    # --- Design ---
    {
        ...
        "kb_topics": ["nextgen2/00-architecture-overview", "sfdc/integration-patterns"],
        "training_topics": ["sfdc-cta-mentor"],
        "description": "Enterprise architecture, patterns, trade-offs, HTML blueprints",
    },
    {
        "id": "ux-designer",
        "name": "UI/UX Designer",
        ...
        "kb_topics": ["codebase/lwc-catalog", "codebase/aura-flexipages"],
        "description": "UX flows, LWC/Aura surface, mockup notes for quoting UI",
    },
    # --- Development ---
    {
        "id": "apex-developer",
        ...
        "kb_topics": ["codebase/apex-services", "codebase/triggers-automation", "sfdc/apex-design-patterns"],
        "training_topics": ["advanced-salesforce-developer"],
        "description": "Bulkified Apex, triggers, CPQ services, Pantheon backend",
    },
    {
        "id": "ui-developer",
        ...
        "cursor_agent": "advanced-salesforce-developer",
        "intents": ["lwc", "lightning", "component", "quoting ui", "pantheon ui"],
        "kb_topics": ["codebase/lwc-catalog", "codebase/pantheon-ui", "sfdc/lwc-fundamentals"],
        "training_topics": ["advanced-salesforce-developer", "playwright-e2e-validation"],
        "description": "LWC/Aura implementation, nextGen quoting UI, bundle views",
    },
    {
        "id": "codebase-worker",
        ...
        "cursor_agent": "advanced-salesforce-developer",
        "intents": ["repo", "codebase", "implement", "fix", "refactor", "pantheon"],
        "kb_topics": ["codebase/*", "nextgen2/*"],
        "description": "Repo-aware changes across force-app, follows existing patterns",
    },
    # --- Admin ---
    {
        "id": "salesforce-admin",
