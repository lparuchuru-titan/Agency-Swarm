...
echo "  cp $DEST/launchd/com.servicetitan.skill-refresh-all.plist ~/Library/LaunchAgents/"
echo "  launchctl load ~/Library/LaunchAgents/com.servicetitan.skill-refresh-all.plist"
