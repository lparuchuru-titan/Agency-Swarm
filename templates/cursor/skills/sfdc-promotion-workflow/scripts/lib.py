...
def load_config(config_path: Path | None = None) -> dict:
    ...
    cfg = {
        ...
        "defaultBaseBranch": file_cfg.get("defaultBaseBranch", ctx.get("defaultBaseBranch", "NextGenDev")),
        "defaultPrTargetBranch": file_cfg.get("defaultPrTargetBranch", ctx.get("defaultPrTargetBranch", "NextGenDev")),
        "defaultOrgAlias": ctx.get("targetOrgAlias"),
        "jiraPrefix": file_cfg.get("jiraPrefix", ctx.get("jiraPrefix", "SFDCLQ")),
